...
function Navbar() {
        ...
        <div className="position-sticky">
          ...
          <Link to="/dashboard" 
            ...
            >
              ...
              </svg><label className="ms-2"> Dashboard</label> </Link>
            ...
            >
             ...
             <label className="ms-2">Clientes</label></Link>
            <Link to="/trabalhadoresList"
              className="ms-2 list-group-item list-group-item-action py-2 ripple"
            >
              ...
              <label className="ms-2">Trabalhadores</label></Link>
            <Link to="/packsList"
              className="ms-2 list-group-item list-group-item-action py-2 ripple"
            >
              ...
              <label className="ms-2">Packs</label></Link>
              <Link to="/formulariosList"
              className="ms-2 list-group-item list-group-item-action py-2 ripple"
            >
  ...
  <path d="M7 2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-1zM0 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm7-1.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-1zm0-5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 8a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zM3 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm0 4.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>
              ...
              <label className="ms-2">Formularios</label></Link>
          </div>
        </div>
      </div>
      {/* Sidebar */}
